...
public class ScoresDBHelper extends SQLiteOpenHelper
{
    ...
    public void onCreate(SQLiteDatabase db)
    {
        final String CreateScoresTable = "CREATE TABLE " + DatabaseContract.SCORES_TABLE + " ("
                ...
                // --- Version 6.0 --->
                + scores_table.HOME_CREST_LINK + " TEXT NOT NULL,"
                + scores_table.AWAY_CREST_LINK + " TEXT NOT NULL,"
                + scores_table.HOME_TEAM_ID + " INTEGER NOT NULL,"
                + scores_table.AWAY_TEAM_ID + " INTEGER NOT NULL,"
                // <---
