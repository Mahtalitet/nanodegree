...
public class ScoresProvider extends ContentProvider
{
    ...
    private static final int MATCHES_WITH_HOME_TEAM_ID = 104;
    private static final int MATCHES_WITH_AWAY_TEAM_ID = 105;
    ...
    private static final String SCORES_BY_HOME_TEAM_ID =
            DatabaseContract.scores_table.HOME_TEAM_ID + " = ?";
    private static final String SCORES_BY_AWAY_TEAM_ID =
            DatabaseContract.scores_table.AWAY_TEAM_ID + " = ?";
    ...
    private int match_uri(Uri uri)
    {
        String link = uri.toString();
        {
           ...
           else if(link.contentEquals(DatabaseContract.scores_table.buildScoreWithHomeTeamId().toString()))
           {
               return MATCHES_WITH_HOME_TEAM_ID;
           }
           else if(link.contentEquals(DatabaseContract.scores_table.buildScoreWithAwayTeamId().toString()))
           {
               return MATCHES_WITH_AWAY_TEAM_ID;
           }
        }
        return -1;
    }
    ...
    public String getType(Uri uri)
    {
        ...
        switch (match) {
            ...
            case MATCHES_WITH_DATE:
                return DatabaseContract.scores_table.CONTENT_TYPE;
            case MATCHES_WITH_HOME_TEAM_ID:
                return DatabaseContract.scores_table.CONTENT_TYPE;
            case MATCHES_WITH_AWAY_TEAM_ID:
                return DatabaseContract.scores_table.CONTENT_TYPE;
            default:
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
    {
        ...
        switch (match)
        {
            ...
            case MATCHES_WITH_HOME_TEAM_ID:
                retCursor = mOpenHelper.getReadableDatabase().query(DatabaseContract.SCORES_TABLE, projection,SCORES_BY_HOME_TEAM_ID, selectionArgs,null,null,null); break;
            case MATCHES_WITH_AWAY_TEAM_ID:
                retCursor = mOpenHelper.getReadableDatabase().query(DatabaseContract.SCORES_TABLE, projection,SCORES_BY_AWAY_TEAM_ID, selectionArgs,null,null,null); break;
