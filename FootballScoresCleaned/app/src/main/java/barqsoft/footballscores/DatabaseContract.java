...
public class DatabaseContract
{
    ...
    public static final class scores_table implements BaseColumns
    {
        ...
        //-- Version 6.0 -->
        public static final String HOME_CREST_LINK = "home_crest_link";
        public static final String AWAY_CREST_LINK = "away_crest_link";
        ...
        public static Uri buildScoreWithHomeTeamId()
        {
            return BASE_CONTENT_URI.buildUpon().appendPath(HOME_TEAM_ID).build();
        }
        public static Uri buildScoreWithAwayTeamId(){
            return BASE_CONTENT_URI.buildUpon().appendPath(AWAY_TEAM_ID).build();
        }
    }
    //URI data
