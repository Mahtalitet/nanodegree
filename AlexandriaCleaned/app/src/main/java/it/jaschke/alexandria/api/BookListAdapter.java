...
public class BookListAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
       ...
       /* viewHolder.bookCover.setScaleType(ImageView.ScaleType.FIT_START);
        final int UNBOUNDED = View.MeasureSpec.makeMeasureSpec(0, View.MeasureSpec.UNSPECIFIED);
        viewHolder.bookCover.measure(UNBOUNDED,UNBOUNDED);
        if(!imgUrl.isEmpty()) {
            int imgHeight = viewHolder.bookCover.getHeight();
